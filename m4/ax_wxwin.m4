...
[
    AC_ARG_WITH([wxdir],
                AC_HELP_STRING([--with-wxdir=PATH],
		               [Use uninstalled version of wxWindows in PATH]),
                [ wx_config_name="$withval/wx-config"
                  wx_config_args="--inplace"])
    AC_ARG_WITH([wx-config],
                AC_HELP_STRING([--with-wx-config=CONFIG],
		               [wx-config script to use (optional)]),
                wx_config_name="$withval" )
    AC_ARG_WITH([wx-prefix],
                AC_HELP_STRING([--with-wx-prefix=PREFIX],
		               [Prefix where wxWindows is installed (optional)]),
                wx_config_prefix="$withval", wx_config_prefix="")
    AC_ARG_WITH([wx-exec-prefix],
                AC_HELP_STRING([--with-wx-exec-prefix=PREFIX],
