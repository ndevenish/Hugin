...
dnl
dnl
dnl changes by dangelo:
dnl  * always check for boost (even when no --with-boost) has been specified)
dnl  * do not check for libraries by default. if a library is wanted, define
dnl    need_boost_xxx=yes, where xxx is the name of library
dnl
       ...
       [
		...
		if test "$succeeded" != "yes" ; then
			...
			AC_DEFINE(HAVE_BOOST,,[define if the Boost library is available])
                	...
                	if test "x$want_boost_program_options" = "xyes"; then
                	...
                	if test "x$want_boost_thread" = "xyes"; then
                	...
                	if test "x$want_boost_iostreams" = "xyes"; then
                	...
                	if test "x$want_boost_signals" = "xyes"; then
                	...
                	if test "x$want_boost_date_time" = "xyes"; then
                    ...
                    ax_cv_boost_date_time=yes, ax_cv_boost_date_time=no)
                        ...
                        if test "x$want_boost_regex" = "xyes"; then
                	...
                	if test "x$want_boost_unit_test_framework" = "xyes"; then
