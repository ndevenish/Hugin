...
ENDIF (NOT WIN32 OR MINGW)
  ...
  FIND_LIBRARY(OPENEXR_ILMTHREAD_LIBRARY NAMES IlmThread-2_2 IlmThread
    PATHS
    ${_OPENEXRLinkDir}
    ${SYSTEM_LIB_DIRS}
    ${SOURCE_BASE_DIR}/Deploy/lib/HuginRelease
  ...
  FIND_LIBRARY(OPENEXR_IMATH_LIBRARY NAMES Imath-2_2 Imath
    PATHS
    ${_OPENEXRLinkDir}
    ${SYSTEM_LIB_DIRS}
    ${SOURCE_BASE_DIR}/Deploy/lib/HuginRelease
  ...
  FIND_LIBRARY(OPENEXR_ILMIMF_LIBRARY NAMES IlmImf-2_2 IlmImf 
    PATHS
    ${_OPENEXRLinkDir}
    ${SYSTEM_LIB_DIRS}
    ${SOURCE_BASE_DIR}/Deploy/lib/HuginRelease
  ...
  FIND_LIBRARY(OPENEXR_ILMTHREAD_LIBRARY_DEBUG NAMES IlmThread-2_2 IlmThread
    PATHS
    ${_OPENEXRLinkDir}
    ${SYSTEM_LIB_DIRS}
    ${SOURCE_BASE_DIR}/Deploy/lib/HuginDebug
  ...
  FIND_LIBRARY(OPENEXR_IMATH_LIBRARY_DEBUG NAMES Imath-2_2 Imath
    PATHS
    ${_OPENEXRLinkDir}
    ${SYSTEM_LIB_DIRS}
    ${SOURCE_BASE_DIR}/Deploy/lib/HuginDebug
  ...
  FIND_LIBRARY(OPENEXR_ILMIMF_LIBRARY_DEBUG NAMES IlmImf-2_2 IlmImf 
    PATHS
    ${_OPENEXRLinkDir}
    ${SYSTEM_LIB_DIRS}
    ${SOURCE_BASE_DIR}/Deploy/lib/HuginDebug
