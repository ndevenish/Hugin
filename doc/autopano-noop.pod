...
autopano-noop - Trivial wrapper script for autopano-sift-c
...
B<autopano-noop> is an obsolete wrapper around autopano-sift-c(1)

If you see a message from B<autopano-noop> or have it configured as a hugin(1)
