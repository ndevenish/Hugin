...
Recently Ippei Ukai, the creator of the XCode project, upgraded to Leopard.
...
3. Build Universal portable bundle
   Cd into the platforms/mac/scripted_universal_build directory and issue the 
   command:  ./02-Make_bundle.sh

4. Add localisation and help to the bundle.
   From the platforms/mac/scripted_universal_build directory issue the 
...
This will finish it up. Share you bundle with the community.
