...
Name: "ap_mockup";         Description: "drop-in Autopano Replacement";                                Types: default full custom;
...
Root: HKCU; Subkey: "Software\hugin\AutoPano";  ValueType: dword; ValueName: "Type"; ValueData:  1; Components: ap_mockup; Tasks: "default_settings"
; which SIFT-C? 0=default, 1=custom
Root: HKCU; Subkey: "Software\hugin\AutoPanoSift";  ValueType: dword; ValueName: "AutopanoExeCustom"; ValueData:  1; Components: ap_mockup; Tasks: "default_settings"
; executable to point to
Root: HKCU; Subkey: "Software\hugin\AutoPanoSift";  ValueType: string; ValueName: "AutopanoExe"; ValueData:  "{app}\bin\autopano-noop.exe"; Components: ap_mockup; Tasks: "default_settings"
; arguments
; Root: HKCU; Subkey: "Software\hugin\AutoPanoSift";  ValueType: string; ValueName: "Args"; ValueData:  "goto panospace.wordpress.com"; Components: ap_mockup; Tasks: "default_settings"
