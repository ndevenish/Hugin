...
AppId=Hugin_prerelease
AppVerName=Hugin @DISPLAY_VERSION@
AppPublisher=@HUGIN_BUILDER@
;You can add your own home page here if you want
AppPublisherURL=
AppVersion=@V_MAJOR@.@V_MINOR@.@V_PATCH@.@HUGIN_WC_REVISION@.@HUGIN_BUILDER@
...
OutputBaseFilename=Hugin_@HUGIN_WC_REVISION@-@HUGIN_BUILDER@_win32_setup
...
Source: PreRelease_Notes.txt; DestDir: {app}\doc; DestName: Release Notes.txt; Components: core; Flags: isreadme overwritereadonly
