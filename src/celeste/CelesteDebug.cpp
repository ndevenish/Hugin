...
void get_gabor_response_debug(string& imagefile, unsigned int& mask, string& model_file, double& threshold,string&
mask_format,vector<double>& svm_responses){

	wxMessageBox(wxString::Format(_("Celeste: Entered get_gabor_response")), _("Celeste"), wxICON_EXCLAMATION);
	...
	wxMessageBox(wxString::Format(_("Celeste: Loaded model")), _("Celeste"), wxICON_EXCLAMATION);
	...
	try{
		...
		wxMessageBox(wxString::Format(_("Celeste: Imported image")), _("Celeste"), wxICON_EXCLAMATION);
		...
		if (info.width() > resize_dimension || info.height() > resize_dimension){
			...
			wxMessageBox(wxString::Format(_("Celeste: Re-sized image")), _("Celeste"), wxICON_EXCLAMATION);
		...
		wxMessageBox(wxString::Format(_("Celeste: Getting L channel values")), _("Celeste"), wxICON_EXCLAMATION);
		...
		wxMessageBox(wxString::Format(_("Celeste: Preparing framebuf")), _("Celeste"), wxICON_EXCLAMATION);
		...
		wxMessageBox(wxString::Format(_("Celeste: Processing locations")), _("Celeste"), wxICON_EXCLAMATION);
		...
		if (gNumLocs){
			...
			wxMessageBox(wxString::Format(_("Celeste: Scaling CPs")), _("Celeste"), wxICON_EXCLAMATION);
			...
			wxMessageBox(wxString::Format(_("Celeste: Gabor filtering")), _("Celeste"), wxICON_EXCLAMATION);
			...
			for (int j = 0; j < gNumLocs; j++){
				...
				wxMessageBox(wxString::Format(_("Celeste: Processing CP %d"),j), _("Celeste"), wxICON_EXCLAMATION);
				...
				wxMessageBox(wxString::Format(_("Celeste: Getting SVM response")), _("Celeste"), wxICON_EXCLAMATION);
		
				svm_responses.push_back(prob_estimates[0]);		

				wxMessageBox(wxString::Format(_("Celeste: CP classified")), _("Celeste"), wxICON_EXCLAMATION);
		...
		wxMessageBox(wxString::Format(_("Celeste: All done. Enter masking?")), _("Celeste"), wxICON_EXCLAMATION);
		...
		wxMessageBox(wxString::Format(_("Celeste: Clean up 1")), _("Celeste"), wxICON_EXCLAMATION);
	...
	wxMessageBox(wxString::Format(_("Celeste: Clean up 2")), _("Celeste"), wxICON_EXCLAMATION);
