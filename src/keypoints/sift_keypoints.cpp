...
/** @file ScaleSpaceTools.cpp
 *
 *  @author Alexandre Jenny <alexandre.jenny@le-geo.com>
 *
 *  $Id$
 *
 *  Some code has been taken from examples supplied with vigra.
 *
 ...
 * For more information, see the LICENSE_SIFT file supplied with the distribution.
 */
...
int main(int argc, char ** argv)
{
    ...
    if (SIGMA > currentScale)
    {
        float preProcGaussianSigma = sqrt ( SIGMA * SIGMA - currentScale * currentScale);
        GaussianBlur( preProcGaussianSigma, fin );
    }
