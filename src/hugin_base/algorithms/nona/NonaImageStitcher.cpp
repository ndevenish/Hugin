...
namespace HuginBase {
    ...
    bool NonaImageStitcher::runStitcher()
    {
        ...
        stitcher.stitch(o_panoramaOptions, o_usedImages,
    ...
    bool NonaDifferenceImageStitcher::runStitcher()
    {
        MultiProgressDisplay* progDisp
            = MultiProgressDisplayAdaptor::newMultiProgressDisplay(getProgressDisplay());
        
        ReduceToDifferenceFunctor<vigra::RGBValue<float> > func;
    ...
    bool NonaHDRImageStitcher::runStitcher()
    {
        MultiProgressDisplay* progDisp
            = MultiProgressDisplayAdaptor::newMultiProgressDisplay(getProgressDisplay());
        
        ReduceToHDRFunctor<vigra::RGBValue<float> > func;
        ReduceStitcher<DestImage, DestAlpha> stitcher(o_panorama, *progDisp);
        stitcher.stitch(o_panoramaOptions, o_usedImages,
                        destImageRange(o_panoImage), destImage(o_alpha),
                        o_remapper,
