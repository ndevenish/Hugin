...
class HuginModule : public QObject
{
    
public:
    HuginModule(QObject* parent = NULL);
    virtual ~HuginModule() {}
    
public:
    virtual HuginModuleInstance* newModuleInstance(QADocument* document) =0;
...
class HuginModuleInstance : public QObject
{
    
public:
    HuginModuleInstance(QADocument* document);
    virtual ~HuginModuleInstance() {}
