...
void CommandHistory::addCommand(Command *command, bool execute)
{
    ...
    if (nextCmd > commands.size()) {
        qFatal("Invalid state in Command History: nextCmd:%d, size:%d",
               nextCmd,commands.size());
