...
BEGIN_EVENT_TABLE(GLOverview, wxPanel)
//    EVT_PAINT (GLOverview::RedrawE)
//    EVT_SIZE  (GLOverview::Resized)
//    EVT_ERASE_BACKGROUND(GLOverview::OnEraseBackground)
//    // mouse motion
//    EVT_MOTION (GLOverview::MouseMotion)
//    // mouse entered or left the preview
//    EVT_LEAVE_WINDOW(GLOverview::MouseLeave)
//    // mouse buttons
//    EVT_LEFT_DOWN (GLOverview::LeftDown)
//    EVT_LEFT_UP (GLOverview::LeftUp)
//    EVT_RIGHT_DOWN (GLOverview::RightDown)
//    EVT_RIGHT_UP (GLOverview::RightUp)
//    // keyboard events
//    EVT_KEY_DOWN(GLOverview::KeyDown)
//    EVT_KEY_UP(GLOverview::KeyUp)
END_EVENT_TABLE()

GLOverview::GLOverview(wxWindow* parent, PT::Panorama &pano, int args[], GLPreviewFrame *frame_in) : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
//          wxGLCanvas(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize,
//                     0, wxT("GLOverviewCanvas"), args, wxNullPalette)
{
...
void GLOverview::SetPhotometricCorrect(bool state)
{
...
void GLOverview::RedrawE(wxPaintEvent& e)
{
...
void GLOverview::RefreshWrapper(void * obj)
{
//    GLOverview* self = (GLOverview*) obj;
//    self->Refresh();
}

void GLOverview::Resized(wxSizeEvent& e)
{
...
void GLOverview::OnEraseBackground(wxEraseEvent& e)
{
    // Do nothing, to avoid flashing on MSW
}

void GLOverview::MouseMotion(wxMouseEvent& e)
{
//    if(m_renderer)
...
void GLOverview::MouseLeave(wxMouseEvent & e)
{
//    if(m_renderer)
//        m_tool_helper->MouseLeave();
}

void GLOverview::LeftDown(wxMouseEvent& e)
{
//    if(m_renderer)
//        m_tool_helper->MouseButtonEvent(e);
}

void GLOverview::LeftUp(wxMouseEvent& e)
{
//    if(m_renderer)
//        m_tool_helper->MouseButtonEvent(e);
}

void GLOverview::RightDown(wxMouseEvent& e)
{
//    if(m_renderer)
//        m_tool_helper->MouseButtonEvent(e);
}

void GLOverview::RightUp(wxMouseEvent& e)
{
//    if(m_renderer)
//        m_tool_helper->MouseButtonEvent(e);
}

void GLOverview::KeyDown(wxKeyEvent& e)
{
//    if(m_renderer)
//        m_tool_helper->KeypressEvent(e.GetKeyCode(), e.GetModifiers(), true);
}

void GLOverview::KeyUp(wxKeyEvent& e)
{
//    if(m_renderer)
