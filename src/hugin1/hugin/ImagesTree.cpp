...
{
    size_t counter=0;
#define ADDCOLUMN(header,mapName,width,align,isEditable,IVE) \
    ...
    ADDCOLUMN(_("Anchor"), "anchor", 60, wxALIGN_LEFT,false, HuginBase::ImageVariableGroup::IVE_Filename)
    ...
    ADDCOLUMN(_("Focal length"), "focallength", 80, wxALIGN_RIGHT,false, HuginBase::ImageVariableGroup::IVE_Filename)
    ...
    ADDCOLUMN(_("Response type"), "response", 80, wxALIGN_LEFT,false, HuginBase::ImageVariableGroup::IVE_Filename)
