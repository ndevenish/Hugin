...
/* use following order: {type, description, program for detector or descriptor, arguments for detector or descriptor,
  ...
  #else
    {CPDetector_AutoPanoSift,wxT("cpfind"),wxT("cpfind"),wxT("-o %o %s"),wxT(""),wxT(""),wxT(""), wxT(""), wxT(""), true},
    {CPDetector_AutoPanoSift,wxT("cpfind + celeste (slower but more accurate, no cps on clouds)"),wxT("cpfind"),wxT("--celeste -o %o %s"),wxT(""),wxT(""),wxT(""), wxT(""), wxT(""), true},
