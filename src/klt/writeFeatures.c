...
//    if (featurelist->feature[i]->val >= 0)  {
      ...
      if (featurelist->feature[i]->x != featurelist->feature[i]->next_x ||
          featurelist->feature[i]->y != featurelist->feature[i]->next_y)
      {
          display_next = 1;
      } else {
          display_next = 0;
...
/*                  
                  if (display_next) {
                      offset = featurelist->feature[i]->next_y * ncols + featurelist->feature[i]->next_x;
                      *(redimg + offset) = 0;
                      *(grnimg + offset) = 255;
                      *(bluimg + offset) = 0;
                  }
