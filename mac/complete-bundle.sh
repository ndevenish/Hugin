...
#temporarily remove hsi again
#binaries="$App/Contents/$dylib_install_loc/*.dylib $App/Contents/MacOS/* $App/Contents/Frameworks/Hugin*.framework/Hugin* $App/Contents/Frameworks/icpfind.framework/icpfind* $App/Contents/Frameworks/local*.framework/local* $App/Contents/Frameworks/_hsi.framework/_hsi* $App/Contents/Resources/align_image_stack $App/Contents/Resources/cpfind"
