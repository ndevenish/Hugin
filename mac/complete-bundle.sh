...
libs="libwx_macu-$WX_MAJOR_VERSOIN libpano13 libboost_thread-mt libboost_thread-mt-1_34_1 libpng libtiff libjpeg libIex libImath libIlmImf libIlmThread libHalf"
