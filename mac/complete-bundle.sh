...
libs="libwx_macu-$WX_MAJOR_VERSION libpano13 libboost_thread $BOOST_THREAD_LIB-$BOOST_VER libpng libtiff libjpeg libIex libImath libIlmImf libIlmThread libHalf libexpat"
