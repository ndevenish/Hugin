...
do
 ...
 SDKVRSION="10.11" #$(echo $MACSDKDIR | sed 's/^[^1]*\([[:digit:]]*\.[[:digit:]]*\).*/\1/')
...
# --with-thread --with-regex --with-iostreams --with-date_time --with-signals \
...
$BJAM -a --stagedir="stage-$ARCH" --prefix=$REPOSITORYDIR $boostTOOLSET -n stage \
 ...
 # mv ./stage-$ARCH/lib/libboost_random.dylib ./stage-$ARCH/lib/libboost_random-$BOOST_VER.dylib
 # mv ./stage-$ARCH/lib/libboost_random.a ./stage-$ARCH/lib/libboost_random-$BOOST_VER.a
 # mv ./stage-$ARCH/lib/libboost_lambda.dylib ./stage-$ARCH/lib/libboost_lambda-$BOOST_VER.dylib
 # mv ./stage-$ARCH/lib/libboost_lambda.a ./stage-$ARCH/lib/libboost_lambda-$BOOST_VER.a
...
for liba in "lib/libboost_filesystem-$BOOST_VER.a" "lib/libboost_system-$BOOST_VER.a" "lib/libboost_filesystem-$BOOST_VER.dylib" "lib/libboost_system-$BOOST_VER.dylib"  # "lib/libboost_thread-$BOOST_VER.a" "lib/libboost_regex-$BOOST_VER.a" "lib/libboost_iostreams-$BOOST_VER.a" "lib/libboost_date_time-$BOOST_VER.a" "lib/libboost_signals-$BOOST_VER.a" "lib/libboost_thread-$BOOST_VER.dylib"  "lib/libboost_regex-$BOOST_VER.dylib"  "lib/libboost_iostreams-$BOOST_VER.dylib" "lib/libboost_date_time-$BOOST_VER.dylib" "lib/libboost_signals-$BOOST_VER.dylib"
do
...
if [ -f "$REPOSITORYDIR/lib/libboost_filesystem-$BOOST_VER.a" ] ; then
  ln -sfn libboost_filesystem-$BOOST_VER.a $REPOSITORYDIR/lib/libboost_filesystem.a;
fi
...
#  install_name_tool -change "libboost_system.dylib" "@executable_path/../Libraries/libboost_system.dylib" "$REPOSITORYDIR/lib/libboost_thread-$BOOST_VER.dylib";
# fi
