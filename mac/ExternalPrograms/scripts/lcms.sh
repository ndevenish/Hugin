...
#     lcms
# ------------------
# $Id: lcms.sh 1902 2007-02-04 22:27:47Z ippei $
...
#for program in bin/icctrans bin/jpegicc bin/tifficc bin/icclink bin/icc2ps bin/tiffdiff bin/wtpt
